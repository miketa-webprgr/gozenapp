...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { food_id: @relationship.food_id, set_menu_id: @relationship.set_menu_id } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { food_id: @relationship.food_id, set_menu_id: @relationship.set_menu_id } }
